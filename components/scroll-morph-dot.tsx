...
const SERVICES_POST_BASE_PATHS = [
  // Unified toolbox silhouette.
  // Lower body + upper body are intentionally in the morph target now.
  ...
  // Handle is included in the morph target too.
